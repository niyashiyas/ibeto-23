...
export default function Rewards() {
  return (
    <div className=" z-10 rounded-b-[66px] rounded-t-[-166px]  flex flex-col items-center relative bg-gradient-to-b from-[#fcfaff] to-[#f9eeff]  py-3 pb-6 lg:py-10 lg:pb-28 px-16 ">
      ...
      <div   data-aos="zoom-in"  data-aos-delay="500"  className="rounded-[30px] bg-[#ffffff1a] border-t-[1px] border-l-[1px] border-[#ffffff80] border-solid shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] hidden lg:block font-body2  backdrop-blur-lg lg:py-24 py-20  lg:px-48 px-12  w-fit mb-6 ">
          ...
          >
            {({ countUpRef, start }) => (
              <VisibilitySensor onChange={start} delayedCall>
                <span className="from-orange-500 to-pink-600 bg-gradient-to-r bg-clip-text text-transparent" ref={countUpRef} />
              </VisibilitySensor>
            )}
          </CountUp>
        </h1 >
      ...
      // Add margin-right for spacing between the icon and text
          ...
          <div className="flex items-center pb-4">
            ...
            // Add margin-right for spacing between the icon and text
            />
            As per KTU regulations, socially relevant projects can avail up to 50 activity points.
          </div>
