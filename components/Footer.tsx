...
export default function Footer() {
  return (
    <>
      <footer className="py-12  z-40 bg1   -mt-16 bg-[#ebd9ff] sm:pt-28 lg:pt-32">
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          ...
          <div className="pt-12 mt-12 text-center border-t border-slate-400 sm:mt-16 lg:mt-20">
            <p className="text-sm font-normal font-body1 text-black">
              © Copyright 2023, All Rights Reserved by Excel MEC
            </p>
          </div>
        </div>
      </footer>
