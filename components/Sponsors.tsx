...
export default function Sponsors() {
  return (
    <div id="sponsors">
      ...
      <section className="py-16 -mt-12   bg-[#0f0416] sm:py-18 lg:py-24 xl:py-28">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto">
            <div className="text-center sm:text-center">
              {/* <p className="text-base font-normal text-white sm:text-lg">Lorem ipsum dolor sit amet{" "}</p> */}
              <h2  data-aos="fade-down" className="mt-9 font-body2 text-3xl font-normal text-white sm:mt-6 sm:text-4xl lg:text-5xl">
                Collaborators{" "}
              </h2>
            </div>

            <hr className="mt-8 border-gray-800 sm:mt-12" />
            <div data-aos="flip-right" className="flex mb-8 w-full justify-center">
